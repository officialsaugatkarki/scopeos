...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'bg-muted text-muted-foreground inline-flex h-9 max-w-full items-center justify-start sm:justify-center rounded-lg p-[3px] overflow-x-auto scrollbar-none',
        className,
      )}
      {...props}
    />
